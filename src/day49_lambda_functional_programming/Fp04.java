...
public class Fp04 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ikiSayiArasindakiTumSayilarinRakamlarToplami(13, 11));
    ...
    public static int verilenIkiSayiArasindakiCiftSayilarinToplami(int x,int y) {
        ...
        if (x > y) {
            ...
            return IntStream.rangeClosed(x, y).filter(Utils::ciftElemanlariYazdir).sum();
   ...
   public static int ikiSayiArasindakiTumSayilarinRakamlarToplami(int x,int y){
       int z = 0;
