...
public class Fp03 {
    public static void main(String[] args) {
     ...
     buyukHarfleYazdir(liste);
       ...
       // uzunlugu8ile10arasiveOileBiteniSil(liste);
        System.out.println("uzunlugu 12'den az mi : "+uzunlugu12denAzMi(liste));
        System.out.println("x ile baslamiyor mu : "+xIleBaslamiyorMu(liste));
        System.out.println("R ile biten var mi : "+rIleBitenVarMi(liste));
  ...
  //  }
    ...
    public static boolean xIleBaslamiyorMu(List<String> list) {
        return list.stream().allMatch(t->t.startsWith("X")||t.startsWith("x"));
    }
