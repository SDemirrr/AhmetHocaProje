...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalama sayilar verilen sayidan buyuk mu? : "+ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 95));
        System.out.println("Kelime kurs adlari icinde var mi?  : "+kelimeKursAdlariIcindeVarMi(coursesList,"Turkish"));
    ...
    public static boolean kelimeKursAdlariIcindeVarMi(List<Courses> list,String x){
