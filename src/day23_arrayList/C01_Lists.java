...
public class C01_Lists {
    public static void main(String[] args) {
        ...
        System.out.println("Listenin boyutu : "+sayilar1.size());//4
        sayilar1.add(2);
        ...
        /*
        set() method'u istenen elementteki eki elementi silip
        yerine verdigimiz yeni elmenti set eder

        eger eski elementi silmek istemiyorsak
        add(index,deger) method'unu kullanabiliriz.

        set() method'u sildigi eski lementi bize dondurur
         */
