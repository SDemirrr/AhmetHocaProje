...
public class C09_ArraydenListYapmak {
    ...
    public static void main(String[] args) {
        ...
        /*
        bu kadar cok lemanli bir listeyi tek tek eleman olarak girmek yerine
        ...
        /*
        Bu islemi yapmasi icin Java'nin
        olusturdugu bir metho'da var ancak
        bu yontemin cok yan etkileri var.

        1-bu sekilde olusturulan listede add
