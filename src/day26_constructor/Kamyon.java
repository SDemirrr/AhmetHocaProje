...
public class Kamyon {
    ...
    public Kamyon(String marka, String model, int yil, int fiyat) {
       ...
       this. fiyat=fiyat;
        ...
        Kamyon class'inda instance variable'e atanmasi
        Ancak scpoe konusunda ogrendigimiz gibi Kamyon constructor'u scope'unda
        marka oldugu icin instance marka'ya gitmiyor.

        Bu karisikligi gidermek icin instance varable'leri belirli hale
        getirmemiz lazim
